package sim.ssn.com.mytestapplication.fragment.expandable;
...
import sim.ssn.com.mytestapplication.fragment.tile.TileFragmentAdapter;
...
/**
 * Created by Simon.Wuensch on 31.08.2016.
 */
public class ExpandableFragment extends Fragment {
    public static String TAG = ExpandableFragment.class.getSimpleName();

    private static int LAYOUT = R.layout.fragment_expandable;
    private static int RECYCLERVIEW = R.id.fragment_expandable_recycler_view;
